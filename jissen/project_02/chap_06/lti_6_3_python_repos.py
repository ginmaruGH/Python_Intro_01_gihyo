...
def make_visualization(repo_links, stars, labels):
    ...
    my_layout = {
        'title': 'GitHubでもっとも多くのスターがついているPythonプロジェクト',
        'titlefont': {'size': 28},
        'xaxis': {
            'title': 'リポジトリ',
            'titlefont': {'size': 24},
    ...
    offline.plot(
        fig,
        filename='jissen/project_02/chap_06/lti_6_3_python_repos.html'
    )
